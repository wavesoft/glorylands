			...
			<td>
				<?php 
					...
					if ($ok) {
						...
						echo "<span class=\"warn\">Missing</span>";
						$issues[]='MemCache extension not found. Memory caching will be disabled.<br /><b>It is highly recommended to mount the /engine/data/cache folder under a RAM filesystem!</b>(16Mb should be enough)';
					}
				?>
			</td>
		</tr>
