...
INSERT INTO `item_vardesc` VALUES ('quality', 'Quality', '3', '1', 'Common', 'ALIAS', '0=%3Cfont+color%3D%23666666%3EJunk%3C%2Ffont%3E&1=%3Cfont+color%3D%23009900%3ENormal%3C%2Ffont%3E&2=%3Cfont+color%3D%230033CC%3ERare%3C%2Ffont%3E&3=%3Cfont+color%3D%23663399%3ELegendary%3C%2Ffont%3E&4=%3Cfont+color%3D%23FF9900%3EEpic%3C%2Ffont%3E&5=%3Cfont+color%3D%23FF0000%3EHeroic%3C%2Ffont%3E', '0');
INSERT INTO `item_vardesc` VALUES ('class', 'Class', '3', '1', 'Unknown', 'SCRIPT', '$name = ucfirst(strtolower($var));\r\nif ($var==\'CONTAINER\') {\r\n  $name .= \" <a href=\\\"javascript:gloryIO(\'?a=interface.container&guid=\".$guid.\"\');\\\"><small><em>(Open)<em></small></a>\";\r\n}\r\nreturn $name;\r\n', '0');
INSERT INTO `item_vardesc` VALUES ('parent', 'Is On', '2', '0', null, 'GUID', null, '0');
INSERT INTO `item_vardesc` VALUES ('subclass', 'Subclass', '3', '0', 'Unknown', 'SCRIPT', 'return ucfirst(strtolower($var));', '0');
INSERT INTO `item_vardesc` VALUES ('mixinfo', 'Mixing', '2', '0', null, 'SCRIPT', 'return \"<font size=\\\"-1\\\">\".gl_mix_visualize($var,true, true).\"</font>\";', '0');
INSERT INTO `item_vardesc` VALUES ('slots', 'Slots', '3', '0', null, 'RAW', null, '0');
